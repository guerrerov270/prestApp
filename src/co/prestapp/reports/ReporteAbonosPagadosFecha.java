...
public class ReporteAbonosPagadosFecha {
	...
	public ReporteAbonosPagadosFecha(String titulo, String nomPDF, Date fechaInicio, Date fechaFin) {
		strRotuloPDF = titulo;
	...
	private void agregarTabla(Paragraph parrafo, Date fechaInicio, Date fechaFin) {
		...
		PdfPCell cell = new PdfPCell(new Paragraph("Listado de abonos pagados por fecha"));
		cell.setColspan(11);
