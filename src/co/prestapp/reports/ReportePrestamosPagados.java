...
public class ReportePrestamosPagados {
	...
	public ReportePrestamosPagados(String titulo, String nomPDF) {
		strRotuloPDF = titulo;
	...
	private void agregarTabla(Paragraph parrafo) {
		...
		PdfPCell cell = new PdfPCell(new Paragraph("Listado de préstamos pagados"));
		cell.setColspan(12);
		...
		try {
			...
			CallableStatement miProcedimiento = conexion.prepareCall("{call listar_prestamos_pagados}");
