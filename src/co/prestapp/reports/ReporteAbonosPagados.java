...
public class ReporteAbonosPagados {
	...
	public ReporteAbonosPagados(String titulo, String nomPDF) {
		strRotuloPDF = titulo;
		...
		try { // Hoja tamanio carta, rotarla (cambiar a horizontal)
			...
			e.printStackTrace();
			error.guardarMensajeError(e.getMessage(), this.getClass().getCanonicalName() + ".ReporteAbonosPagados");
		}
	}
	...
	private void agregarTabla(Paragraph parrafo) {
		...
		PdfPCell cell = new PdfPCell(new Paragraph("Listado de abonos pagados"));
		cell.setColspan(11);
